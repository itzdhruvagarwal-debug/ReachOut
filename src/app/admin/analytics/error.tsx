...
export default function AdminAnalyticsError({
  ...
  return (
    ...
    >
      ...
      <h2 className="text-xl font-bold text-foreground">Analytics failed to load</h2>
      <p className="text-muted-foreground text-sm max-w-md">
        Platform analytics metrics could not be fetched. Check service connectivity and try again.
      </p>
      {error.digest && (
