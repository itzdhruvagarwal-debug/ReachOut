        ...
        <aside className="settings-sidebar">
          ...
          <div className="hidden md:block p-3 border-t border-border mt-auto space-y-2.5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2 px-3 rounded-xl text-xs font-semibold text-destructive hover:bg-destructive/10 border border-destructive/20 hover:border-destructive/30 transition-all focus:outline-none"
              title="Sign Out"
              aria-label="Sign Out"
            >
          ...
          <div className="settings-content-header">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <button
                ...
                title="Sign Out"
                aria-label="Sign Out"
                className="px-2.5 py-2 sm:px-3 sm:py-2 rounded-xl border border-destructive/25 text-destructive hover:bg-destructive/10 hover:border-destructive/40 transition-all text-xs font-semibold flex items-center gap-1.5 focus:outline-none shadow-xs"
              >
