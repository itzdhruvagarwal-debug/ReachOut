  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // ---------------------------------------------------------------------
        // VyaparMedia Financial Escrow & Trust Semantic Design Tokens
        // ---------------------------------------------------------------------
        escrow: {
          DEFAULT: "hsl(var(--escrow))",
          foreground: "hsl(var(--escrow-foreground))",
          muted: "hsl(var(--escrow-muted))",
          border: "hsl(var(--escrow-border))",
        },
        verified: {
        ...
        disputed: {
          ...
          muted: "hsl(var(--disputed-muted))",
          border: "hsl(var(--disputed-border))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
